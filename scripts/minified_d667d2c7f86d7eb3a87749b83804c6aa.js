...
$(".link-to-home").removeClass("active")}});$(".navbar-toggle").click(function(){$("#menu").addClass("show-menu")})});function smf_AdminIndex(oOptions)
...
{document.getElementById("uploadMore").style.display=document.getElementById("uploadSmiley").disabled?"none":"";document.getElementById("uploadSmiley").disabled=!document.getElementById("uploadSmiley").disabled}
...
{var currentImage=document.getElementById("preview");currentImage.src=smf_smileys_url+"/"+document.forms.smileyForm.set.value+"/"+document.forms.smileyForm.smiley_filename.value}
function swap_database_changes()
{db_vis=!db_vis;database_changes_area.style.display=db_vis?"":"none";return!1}
function testFTP()
...
{dir_elem.disabled=1}
else dir_elem.disabled=!sub_dir.checked};var pingTime=10000;var updateAlerts=function()
