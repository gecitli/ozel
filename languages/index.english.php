...
$txt['welcome_guest_register'] = '<a class="header__user-panel-link header__user-panel-link--login" href="%3$s" onclick="%4$s"><i class="fas fa-sign-in-alt"></i> login</a> 
 <a class="header__user-panel-link header__user-panel-link--register" href="%5$s"><i class="fas fa-user-plus"></i> sign up</a>.';
